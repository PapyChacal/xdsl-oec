...
builtin.module {
  func.func @nh_p_grad(%arg0: !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>, %arg1: !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>, %arg2: !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>, %arg3: !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>, %arg4: !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>, %arg5: !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>, %arg6: !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>, %arg7: !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>, %arg8: !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>, %arg9: !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>) attributes {stencil.program} {
    ...
    %9 = stencil.cast %arg9 : !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64> -> !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>
    ...
    %13 = stencil.load %3 : !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64> -> !stencil.temp<?x?x?xf64>
    %14 = stencil.load %4 : !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64> -> !stencil.temp<?x?x?xf64>
    %15 = stencil.load %5 : !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64> -> !stencil.temp<?x?x?xf64>
    %16 = stencil.load %6 : !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64> -> !stencil.temp<?x?x?xf64>
    %17 = stencil.load %7 : !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64> -> !stencil.temp<?x?x?xf64>
    %18 = stencil.apply (%arg10 = %16 : !stencil.temp<?x?x?xf64>) -> (!stencil.temp<?x?x?xf64>) {
      %23 = stencil.access %arg10 [0, 0, 1] : !stencil.temp<?x?x?xf64>
    ...
    %19 = stencil.apply (%arg10 = %18 : !stencil.temp<?x?x?xf64>, %arg11 = %14 : !stencil.temp<?x?x?xf64>, %arg12 = %16 : !stencil.temp<?x?x?xf64>) -> (!stencil.temp<?x?x?xf64>) {
      ...
      %23 = stencil.access %arg11 [0, 0, 1] : !stencil.temp<?x?x?xf64>
      %24 = stencil.access %arg11 [1, 0, 0] : !stencil.temp<?x?x?xf64>
      %25 = arith.subf %23, %24 : f64
      %26 = stencil.access %arg12 [1, 0, 1] : !stencil.temp<?x?x?xf64>
      ...
      %31 = stencil.access %arg11 [1, 0, 1] : !stencil.temp<?x?x?xf64>
      %32 = arith.subf %30, %31 : f64
      %33 = stencil.access %arg12 [0, 0, 1] : !stencil.temp<?x?x?xf64>
      %34 = stencil.access %arg12 [1, 0, 0] : !stencil.temp<?x?x?xf64>
      %35 = arith.subf %33, %34 : f64
      %36 = arith.mulf %32, %35 : f64
      %37 = arith.addf %29, %36 : f64
      %38 = stencil.access %arg10 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %39 = stencil.access %arg10 [1, 0, 0] : !stencil.temp<?x?x?xf64>
      %40 = arith.addf %38, %39 : f64
      %41 = arith.divf %cst, %40 : f64
    ...
    %20 = stencil.apply (%arg10 = %18 : !stencil.temp<?x?x?xf64>, %arg11 = %14 : !stencil.temp<?x?x?xf64>, %arg12 = %16 : !stencil.temp<?x?x?xf64>) -> (!stencil.temp<?x?x?xf64>) {
      %cst = arith.constant 1.000000e-01 : f64
      %23 = stencil.access %arg11 [0, 0, 1] : !stencil.temp<?x?x?xf64>
      %24 = stencil.access %arg11 [0, 1, 0] : !stencil.temp<?x?x?xf64>
      %25 = arith.subf %23, %24 : f64
      %26 = stencil.access %arg12 [0, 1, 1] : !stencil.temp<?x?x?xf64>
      %27 = stencil.access %arg12 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %28 = arith.subf %26, %27 : f64
      %29 = arith.mulf %25, %28 : f64
      %30 = stencil.access %arg11 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %31 = stencil.access %arg11 [0, 1, 1] : !stencil.temp<?x?x?xf64>
      %32 = arith.subf %30, %31 : f64
      %33 = stencil.access %arg12 [0, 0, 1] : !stencil.temp<?x?x?xf64>
      %34 = stencil.access %arg12 [0, 1, 0] : !stencil.temp<?x?x?xf64>
      %35 = arith.subf %33, %34 : f64
      %36 = arith.mulf %32, %35 : f64
      %37 = arith.addf %29, %36 : f64
      %38 = stencil.access %arg10 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %39 = stencil.access %arg10 [0, 1, 0] : !stencil.temp<?x?x?xf64>
      %40 = arith.addf %38, %39 : f64
      %41 = arith.divf %cst, %40 : f64
      %42 = arith.mulf %37, %41 : f64
      %43 = stencil.store_result %42 : !stencil.result<f64>
    ...
    %21 = stencil.apply (%arg10 = %10 : !stencil.temp<?x?x?xf64>, %arg11 = %17 : !stencil.temp<?x?x?xf64>, %arg12 = %14 : !stencil.temp<?x?x?xf64>, %arg13 = %15 : !stencil.temp<?x?x?xf64>, %arg14 = %19 : !stencil.temp<?x?x?xf64>, %arg15 = %12 : !stencil.temp<?x?x?xf64>) -> (!stencil.temp<?x?x?xf64>) {
      %cst = arith.constant 1.000000e-01 : f64
      %23 = stencil.access %arg12 [0, 0, 1] : !stencil.temp<?x?x?xf64>
      %24 = stencil.access %arg12 [1, 0, 0] : !stencil.temp<?x?x?xf64>
      %25 = arith.subf %23, %24 : f64
      %26 = stencil.access %arg13 [1, 0, 1] : !stencil.temp<?x?x?xf64>
      %27 = stencil.access %arg13 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %28 = arith.subf %26, %27 : f64
      %29 = arith.mulf %25, %28 : f64
      %30 = stencil.access %arg12 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %31 = stencil.access %arg12 [1, 0, 1] : !stencil.temp<?x?x?xf64>
      %32 = arith.subf %30, %31 : f64
      %33 = stencil.access %arg13 [0, 0, 1] : !stencil.temp<?x?x?xf64>
      %34 = stencil.access %arg13 [1, 0, 0] : !stencil.temp<?x?x?xf64>
      %35 = arith.subf %33, %34 : f64
      %36 = arith.mulf %32, %35 : f64
      %37 = arith.addf %29, %36 : f64
      %38 = stencil.access %arg11 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %39 = stencil.access %arg11 [1, 0, 0] : !stencil.temp<?x?x?xf64>
      %40 = arith.addf %38, %39 : f64
      %41 = arith.divf %cst, %40 : f64
      %42 = arith.mulf %37, %41 : f64
      %43 = stencil.access %arg10 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %44 = stencil.access %arg14 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %45 = arith.addf %43, %44 : f64
      %46 = arith.addf %42, %45 : f64
      %47 = stencil.access %arg15 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %48 = arith.mulf %46, %47 : f64
      %49 = stencil.store_result %48 : !stencil.result<f64>
    ...
    %22 = stencil.apply (%arg10 = %11 : !stencil.temp<?x?x?xf64>, %arg11 = %17 : !stencil.temp<?x?x?xf64>, %arg12 = %14 : !stencil.temp<?x?x?xf64>, %arg13 = %15 : !stencil.temp<?x?x?xf64>, %arg14 = %20 : !stencil.temp<?x?x?xf64>, %arg15 = %13 : !stencil.temp<?x?x?xf64>) -> (!stencil.temp<?x?x?xf64>) {
      %cst = arith.constant 1.000000e-01 : f64
      %23 = stencil.access %arg12 [0, 0, 1] : !stencil.temp<?x?x?xf64>
      %24 = stencil.access %arg12 [0, 1, 0] : !stencil.temp<?x?x?xf64>
      %25 = arith.subf %23, %24 : f64
      %26 = stencil.access %arg13 [0, 1, 1] : !stencil.temp<?x?x?xf64>
      %27 = stencil.access %arg13 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %28 = arith.subf %26, %27 : f64
      %29 = arith.mulf %25, %28 : f64
      %30 = stencil.access %arg12 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %31 = stencil.access %arg12 [0, 1, 1] : !stencil.temp<?x?x?xf64>
      %32 = arith.subf %30, %31 : f64
      %33 = stencil.access %arg13 [0, 0, 1] : !stencil.temp<?x?x?xf64>
      %34 = stencil.access %arg13 [0, 1, 0] : !stencil.temp<?x?x?xf64>
      %35 = arith.subf %33, %34 : f64
      %36 = arith.mulf %32, %35 : f64
      %37 = arith.addf %29, %36 : f64
      %38 = stencil.access %arg11 [0, 0, 0] : !stencil.temp<?x?x?xf64>
      %39 = stencil.access %arg11 [0, 1, 0] : !stencil.temp<?x?x?xf64>
      %40 = arith.addf %38, %39 : f64
      %41 = arith.divf %cst, %40 : f64
      %42 = arith.mulf %37, %41 : f64
      %43 = stencil.access %arg10 [0, 0, 0] : !stencil.temp<?x?x?xf64>
    ...
    stencil.store %21 to %8([0, 0, 0] : [64, 64, 64]) : !stencil.temp<?x?x?xf64> to !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>
    stencil.store %22 to %9([0, 0, 0] : [64, 64, 64]) : !stencil.temp<?x?x?xf64> to !stencil.field<[-4,68]x[-4,68]x[-4,68]xf64>
    func.return
  }
}
