...
extern "C" {
void fvtp2d_flux(LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT);
}
...
int main(int argc, char **argv) {
  ...
  fillMath(3.2, 7.0, 2.5, 6.1, 3.0, 2.3, arg7, domain_size, domain_height);
  ...
  for(int i = 0; i < 512; i++)
    fvtp2d_flux(LLVMMemref3D(arg0), LLVMMemref3D(arg1), LLVMMemref3D(arg2), LLVMMemref3D(arg3), LLVMMemref3D(arg4), LLVMMemref3D(arg5), LLVMMemref3D(arg6), LLVMMemref3D(arg7), LLVMMemref3D(arg8));
