...
extern "C" {
void fvtp2d_qi(LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT);
}
...
int main(int argc, char **argv) {
  ...
  initValue(arg6, -1.0, domain_size, domain_height);

  toDevice(arg0, arg1, arg2, arg3, arg4, arg5, arg6);


  TIMER_START();

  for(int i = 0; i < 512; i++)
    fvtp2d_qi(LLVMMemref3D(arg0), LLVMMemref3D(arg1), LLVMMemref3D(arg2), LLVMMemref3D(arg3), LLVMMemref3D(arg4), LLVMMemref3D(arg5), LLVMMemref3D(arg6));

  TIMER_STOP();

  toHost(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
