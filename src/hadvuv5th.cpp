...
extern "C" {
void hadvuv5th(LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT, LLVMMemref3DT, LLVMMemref1DT, LLVMMemref1DT, LLVMMemref1DT, LLVMMemref1DT);
}
...
int main(int argc, char **argv) {
  ...
  fillMath(8.0, 9.4, 1.5, 1.7, 2.0, 3.5, arg5, domain_size, domain_height);
  fillMath(8.0, 9.4, 1.5, 1.7, 2.0, 3.5, arg6, domain_size, domain_height);
  fillMath(8.0, 9.4, 1.5, 1.7, 2.0, 3.5, arg7, domain_size, domain_height);


  toDevice(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);


  TIMER_START();

  for(int i = 0; i < 512; i++)
    hadvuv5th(LLVMMemref3D(arg0), LLVMMemref3D(arg1), LLVMMemref3D(arg2), LLVMMemref3D(arg3), LLVMMemref1D(arg4), LLVMMemref1D(arg5), LLVMMemref1D(arg6), LLVMMemref1D(arg7));

  TIMER_STOP();

  toHost(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
